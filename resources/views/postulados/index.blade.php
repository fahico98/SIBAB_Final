	...
	<div class="card">
		<div class="row justify-content-center">
			<div class="form-group">
				<h3 class="TituloListaAprendices">Lista de Aprendices Postulados</h3>
			</div>
			<div class="col-md-12">
					...
					<table class="table">
						<thead>
							<tr>
								...
								<th class="text-center">Ver formularios</th>
						...
						@if($Postulado->estado_postulacion == 'Postulado')
						<tbody>
							<tr>
											...
											<div class="modal-content">
												...
												<form method="POST" action="{{route('puntaje_postulado',[$Postulado->id_postulacion])}}">
													...
													<div class="modal-body">
														...
														<input type="number" min="1" name="puntaje" class="form-control col-md-10 @error('nombre_beneficio') is-invalid @enderror">
								...
								@if($Postulado->id_socioeconomico != '' && $Postulado->id_savia != '')
								<td class="text-center"><a class="btn btn-info" href="{{ route ('editSavia', [$Postulado->id_postulacion])}}"><i class="material-icons">portrait</i>
								</td>
								@else
								<td class="text-center"><a class="btn btn-info" href="{{ route ('editSocio', [$Postulado->id_postulacion])}}"><i class="material-icons">portrait</i>
								</td>
								@endif
								<td class="text-center">
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal-{{$Postulado->id_postulacion}}">
									...
									<div class="modal fade" id="exampleModal-{{$Postulado->id_postulacion}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form method="POST" action="{{route('postulado_estado',[$Postulado->id_postulacion])}}">
													{{ csrf_field() }}
													@method('PUT')
													<div class="modal-body">
														...
														<div class="col-md-4" style="margin-left: 34%;">
															<select name="estado" class="form-control @error('estado') is-invalid @enderror">
																<option value="Postulado" @if($Postulado->estado_postulacion== 'Postulado' ) selected @endif>Postulado</option>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form method="POST" action="{{route('puntaje_postulado',[$Postulado->id_postulacion])}}">
													...
													<div class="modal-body">
														<label>¿Que calificación le vas a dar a esta postulación?</label>
														<input type="number" min="1" name="puntaje">
													</div>
													<div class="modal-footer">
														<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
														<button type="submit" class="btn btn-primary">Guardar</button>
