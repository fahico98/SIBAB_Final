	...
	<div class="card">
		<div class="card-body">
			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						<label for="fecha_inicio">Fecha de inicio lectiva *</label>
						<input type="date" class="form-control" name="fecha_inicio" disabled="" value="{{$saviaIA->fecha_inicio}}">
					</div>
					<div class="form-group">
						<label for="tipo_formacion">Tipo de formación *</label>
						<input type="text" class="form-control" name="tipo_formacion" disabled="" value="{{$saviaIA->tipo_formacion}}">
					</div>
					<div class="form-group">
						<label for="dedicacion_estudio">Dedicación a estudio *</label>
						<input type="text" class="form-control" name="dedicacion_estudio" disabled="" value="{{$saviaIA->dedicacion_estudio}}">
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						<label for="fecha_terminacion">Fecha de fin lectiva *</label>
						<input type="date" class="form-control" name="fecha_terminacion" disabled="" value="{{$saviaIA->fecha_terminacion}}">
					</div>
					<div class="form-group">
						<label for="jornada">Horario de formación *</label>
						<input type="text" class="form-control" name="jornada" disabled="" @if($saviaIA->jornada == 1) value="Día" @else value="Noche" @endif>
					</div>
					<div class="form-group">
						<label for="horario_formacion">Horario *</label>
						<input type="time" class="form-control" name="horario_formacion" disabled="" value="{{$saviaIA->horario_formacion}}">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-12">
					<label for="horas_centro_formacion" class="form-label">Cuantas horas permanece en el Centro de formación, y en función de que?: * </label>
					<div class="form-group">
						<textarea id="horas_centro_formacion" class="col-md-12" name="horas_centro_formacion" rows="4" disabled="" placeholder="Horan en el centro de formacion">{{$saviaIA->horas_centro_formacion}}</textarea>
					</div>
				</div>
			</div>
			<div class="row">
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="form-check">
										<label class="form-check-label">
											<input class="form-check-input" type="checkbox" name="regimen_subsidiado" disabled="" id="regimen_subsidiado" @if($saviaIP->regimen_subsidiado == 1) checked="" @endif>
							...
							<tr>
								...
								<td>
									<div class="form-check">
										<label class="form-check-label">
											<input class="form-check-input" type="checkbox" name="regimen_contributivo" id="regimen_contributivo" disabled="" @if($saviaIP->regimen_contributivo == 1) checked="" @endif>
											<span class="form-check-sign" style="margin-left: 55%">
												<span class="check"></span>
											</span>
										</label>
							...
							<tr>
								...
								<td>
									<div class="form-check">
										<label class="form-check-label">
											<input class="form-check-input" type="checkbox" name="puntajeSisben" id="puntajeSisben" disabled="" @if($saviaIP->puntajeSisben == 1) checked="" @endif>
											<span class="form-check-sign" style="margin-left: 55%">
												<span class="check"></span>
											</span>
										</label>
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="form-check">
										<label class="form-check-label">
											<input class="form-check-input" type="checkbox" name="tres_comidas" id="tres_comidas" disabled="" @if($saviaIP->tres_comidas == 1) checked="" @endif>
											<span class="form-check-sign" style="margin-left: 55%">
												<span class="check"></span>
											</span>
										</label>
							...
							<tr>
								...
								<td>
									<div class="form-check">
										<label class="form-check-label">
											<input class="form-check-input" type="checkbox" name="nutrientes" id="nutrientes" disabled="" @if($saviaIP->nutrientes == 1) checked="" @endif>
											<span class="form-check-sign" style="margin-left: 55%">
												<span class="check"></span>
											</span>
										</label>
							...
							<tr>
								...
								<td>
									<div class="form-check">
										<label class="form-check-label">
											<input class="form-check-input" type="checkbox" name="desplazamiento_forzado" id="desplazamiento_forzado" disabled="" @if($saviaIP->desplazamiento_forzado == 1) checked="" @endif >
											<span class="form-check-sign" style="margin-left: 55%">
												<span class="check"></span>
											</span>
										</label>
